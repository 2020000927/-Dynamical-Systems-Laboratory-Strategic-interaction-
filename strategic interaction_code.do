...
esttab sdm_re_w1 sdm_fe_both_w1 using CI_sdm_w1.rtf,se mtitles star(* 0.1 ** 0.05 *** 0.01) b(%4.3f) se(%4.3f) r2(%4.3f) 
**hausman test
...
est sto sdm_fe_both
esttab sdm_re sdm_fe_time sdm_fe_ind sdm_fe_both using CI_sdm.rtf,se mtitles star(* 0.1 ** 0.05 *** 0.01) b(%4.3f) se(%4.3f) r2(%4.3f) 
...
*================================================================================
Figure 2. Heterogeneity analysis of strategic interaction between different cities. 
 
Figure 3. Histogram of the strategic interaction patterns in carbon regulations. (use matlab)
*================================================================================
