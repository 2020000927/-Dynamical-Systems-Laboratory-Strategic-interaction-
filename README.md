# -Dynamical-Systems-Laboratory-Strategic-interaction-
...
1-A do file. The do file includes the code of baseline model(Table 1),Effect analysis(Table 2),robust test(Table E5) and temporal and spatial heterogeneity analysis(Figure1).  
